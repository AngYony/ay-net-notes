...
namespace xbd.ModbusPro
{
    ...
    public partial class FrmModbusRTU : Form
    {
        ...
        private ModbusRTU modbus = new ModbusRTU(); //通信对象
        ...
        private void InitParam()
        {
            ...
            //初始化波特率
            this.cmb_BaudRate.Items.AddRange(new[] { "4800", "9600", "19200", "38400" });
            ...
            //初始化数据位
            this.cmb_DataBits.Items.AddRange(new[] { "7", "8" });
        ...
        private void Btn_Open_Click(object sender, EventArgs e)
        {
            ...
            Parity parity = GetEnumValue<Parity>(this.cmb_Parity.Text.Trim());
            StopBits stopBits = GetEnumValue<StopBits>(this.cmb_StopBits.Text.Trim());

            var result = modbus.Open(cmb_PortName.Text,
                 Convert.ToInt32(this.cmb_BaudRate.Text),
                 parity,
                 Convert.ToInt32(this.cmb_DataBits.Text.Trim()),
                 stopBits);
            ...
            {
                AddLog(3, "串口打开失败:" + result.Message);
                isConnected = false;
