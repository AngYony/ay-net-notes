...
using System.Linq;
using DateTime = AY.CommunicationLib.PLC.Siemens.Types.DateTime;
...
namespace AY.CommunicationLib.PLC.Siemens
{
    public partial class Plc
    {
        ...
        /// <returns></returns>
        private static void BuildReadDataRequestPackage(System.IO.MemoryStream stream, StoreType dataType, int db, int startByteAdr, int count = 1)
        {
            //single data req = 12
