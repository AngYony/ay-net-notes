...
namespace AY.CommunicationLib.PLC.Siemens
{
    ...
    public static class Conversion
    {
        ...
        {
            uint output;
            output = AY.CommunicationLib.PLC.Siemens.Types.DWord.FromByteArray(AY.CommunicationLib.PLC.Siemens.Types.Real.ToByteArray(input));
            return output;
        }
        ...
        {
            float output;
            output = AY.CommunicationLib.PLC.Siemens.Types.Real.FromByteArray(AY.CommunicationLib.PLC.Siemens.Types.DWord.ToByteArray(input));
            return output;
        }
    }
}
