...
namespace AY.CommunicationLib.PLC.Siemens.Types
{
    /// <summary>
            ...
            foreach (var info in infos)
            {
                ...
                switch (info.FieldType.Name)
                {
                    ...
                    case "String":
                        ...
                        {
                            case S7StringType.S7String:
                                bytes2 = S7String.ToByteArray((string)info.GetValue(structValue), attribute.ReservedLength);
                                break;
                            case S7StringType.S7WString:
                                bytes2 = S7WString.ToByteArray((string)info.GetValue(structValue), attribute.ReservedLength);
                                break;
                            default:
                                throw new ArgumentException("Please use a valid string type for the S7StringAttribute");
                        }
