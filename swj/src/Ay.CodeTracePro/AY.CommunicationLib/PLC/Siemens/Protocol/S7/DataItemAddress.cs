namespace AY.CommunicationLib.PLC.Siemens.Protocol.S7
{
    /// <summary>
    ...
    {
        public DataItemAddress(StoreType dataType, int db, int startByteAddress, int byteLength)
        {
            DataType = dataType;
            DB = db;
