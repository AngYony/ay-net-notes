...
using AY.CommunicationLib.PLC.Siemens.Protocol;
using System.Threading;
using AY.CommunicationLib.PLC.Siemens.Protocol.S7;
using AY.CommunicationLib.PLC.Siemens.Types;

namespace AY.CommunicationLib.PLC.Siemens
{
    /// <summary>
    /// Creates an instance of AY.CommunicationLib.Siemens driver
    /// </summary>
    public partial class Plc
    {
        ...
        public async Task<byte[]> ReadBytesAsync(StoreType dataType, int db, int startByteAdr, int count, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken">The token to monitor for cancellation requests. The default value is None.
        /// Please note that cancellation is advisory/cooperative and will not lead to immediate cancellation in all cases.</param>
        public async Task<object> ReadAsync(StoreType dataType, int db, int startByteAdr, VarType varType, int varCount, byte bitAdr = 0, CancellationToken cancellationToken = default)
        {
        ...
        public async Task<object> ReadStructAsync(Type structType, int db, int startByteAdr = 0, CancellationToken cancellationToken = default)
        {
            ...
            var resultBytes = await ReadBytesAsync(StoreType.DataBlock, db, startByteAdr, numBytes, cancellationToken).ConfigureAwait(false);
        ...
        public async Task WriteBytesAsync(StoreType dataType, int db, int startByteAdr, byte[] value, CancellationToken cancellationToken = default)
        {
            int localIndex = 0;
        ...
        /// Please note that cancellation is advisory/cooperative and will not lead to immediate cancellation in all cases.</param>
        /// <returns>A task that represents the asynchronous write operation.</returns>
        public async Task WriteBitAsync(StoreType dataType, int db, int startByteAdr, int bitAdr, bool value, CancellationToken cancellationToken = default)
        {
        ...
        /// Please note that cancellation is advisory/cooperative and will not lead to immediate cancellation in all cases.</param>
        /// <returns>A task that represents the asynchronous write operation.</returns>
        public async Task WriteBitAsync(StoreType dataType, int db, int startByteAdr, int bitAdr, int value, CancellationToken cancellationToken = default)
        {
            if (value < 0 || value > 1)
        ...
        /// Please note that cancellation is advisory/cooperative and will not lead to immediate cancellation in all cases.</param>
        /// <returns>A task that represents the asynchronous write operation.</returns>
        public async Task WriteAsync(StoreType dataType, int db, int startByteAdr, object value, int bitAdr = -1, CancellationToken cancellationToken = default)
        {
            if (bitAdr != -1)
            {
        ...
        public async Task WriteStructAsync(object structValue, int db, int startByteAdr = 0, CancellationToken cancellationToken = default)
        {
            ...
            await WriteBytesAsync(StoreType.DataBlock, db, startByteAdr, bytes.ToArray(), cancellationToken).ConfigureAwait(false);
        }
        ...
        public async Task WriteClassAsync(object classValue, int db, int startByteAdr = 0, CancellationToken cancellationToken = default)
        {
            ...
            await WriteBytesAsync(StoreType.DataBlock, db, startByteAdr, bytes, cancellationToken).ConfigureAwait(false);
        }

        private async Task ReadBytesWithSingleRequestAsync(StoreType dataType, int db, int startByteAdr, byte[] buffer, int offset, int count, CancellationToken cancellationToken)
        {
        ...
        /// <returns>A task that represents the asynchronous write operation.</returns>
        private async Task WriteBytesWithASingleRequestAsync(StoreType dataType, int db, int startByteAdr, byte[] value, int dataOffset, int count, CancellationToken cancellationToken)
        {
            try
            {
        ...
        private async Task WriteBitWithASingleRequestAsync(StoreType dataType, int db, int startByteAdr, int bitAdr, bool bitValue, CancellationToken cancellationToken)
        {
            try
            {
