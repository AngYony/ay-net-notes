...
namespace xbd.s7netplus
{
    ...
    public static class Conversion
    {
        ...
        {
            uint output;
            output = xbd.s7netplus.Types.DWord.FromByteArray(xbd.s7netplus.Types.Real.ToByteArray(input));
            return output;
        }
        ...
        {
            float output;
            output = xbd.s7netplus.Types.Real.FromByteArray(xbd.s7netplus.Types.DWord.ToByteArray(input));
            return output;
        }
    }
}
